...
class SubjectCharacterAdapter : BaseQuickAdapter<CharacterData, QuickViewHolder>() {
    ...
    override fun onBindViewHolder(holder: QuickViewHolder, position: Int, item: CharacterData?) {
        holder.also { h ->
